...
This guide provides comprehensive documentation for the **database-integration** skill in the custom-plugin-fullstack plugin.
...
```bash
# Invoke the skill
claude "database-integration - [your task description]"

# Example
claude "database-integration - analyze the current implementation"
```
...
def implement_database_integration(input_data):
    """
    Implement database-integration functionality.
