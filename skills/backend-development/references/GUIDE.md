...
This guide provides comprehensive documentation for the **backend-development** skill in the custom-plugin-fullstack plugin.
...
```bash
# Invoke the skill
claude "backend-development - [your task description]"

# Example
claude "backend-development - analyze the current implementation"
```
...
def implement_backend_development(input_data):
    """
