# Fullstack Basics Guide

## Overview

This guide provides comprehensive documentation for the **fullstack-basics** skill in the custom-plugin-fullstack plugin.
...
```bash
# Invoke the skill
claude "fullstack-basics - [your task description]"

# Example
claude "fullstack-basics - analyze the current implementation"
```
...
def implement_fullstack_basics(input_data):
    """
    Implement fullstack-basics functionality.
