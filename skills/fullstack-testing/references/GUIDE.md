# Fullstack Testing Guide

## Overview

This guide provides comprehensive documentation for the **fullstack-testing** skill in the custom-plugin-fullstack plugin.
...
```bash
# Invoke the skill
claude "fullstack-testing - [your task description]"

# Example
claude "fullstack-testing - analyze the current implementation"
```
...
def implement_fullstack_testing(input_data):
    """
    Implement fullstack-testing functionality.
