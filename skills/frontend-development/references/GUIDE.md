...
This guide provides comprehensive documentation for the **frontend-development** skill in the custom-plugin-fullstack plugin.
...
```bash
# Invoke the skill
claude "frontend-development - [your task description]"

# Example
claude "frontend-development - analyze the current implementation"
```
...
def implement_frontend_development(input_data):
    """
